...
public class CadastroExameAdmissionalPage extends BasePage {
	...
	public String verificarDataTelaApp01() {

		String data01 = obterTextoAtributo(By.xpath("(//android.view.View)[10]"));

		String data02 = data01.replaceAll("\n", " ");

		return data02.substring(187, 197).trim();

	}

	public String verificarDataExame() {
		...
		String dta = dataExame.replace("/", ".");
		String dta2 = dta.substring(0, 5);
		String dta3 = dta.substring(8, 10);
	...
	public void botaoVerComDetalhes() {
		clicar(MobileBy.AccessibilityId("VER COM DETALHE"));

	}

	public String verificarHoraTela01() {
		return obterTextoAtributo(By.xpath("(//android.view.View)[12]"));

	}

	public String verificarDataTelaApp02() {

		String dataTelaConfirmacao = obterTextoAtributo(By.xpath("(//android.widget.ImageView)[2]"));
		String data01 = dataTelaConfirmacao.substring(187, 196).replaceAll("\n", "").trim();

		return data01;

	}

	public String verificarDataTelaApp03() {

		String dataTelaConfirmacao = obterTextoAtributo(By.xpath("(//android.widget.ImageView)[1]"));
		String data01 = dataTelaConfirmacao.replaceAll("\n", " ");
		String data02 = data01.substring(14, 22);
		return data02.trim();
		// DATA DO EXAME29.06.22ClinicaUmRua da Automacao 400

	}

	public String verificarNomeClinicaTelaApp() {

		String dataTelaConfirmacao = obterTextoAtributo(By.xpath("(//android.widget.ImageView)[1]"));
		String endereco01 = dataTelaConfirmacao.replaceAll("\n", " ");
		String endereco02 = endereco01.substring(23, 40);
		return endereco02.trim();

	}

	public String verificarEnderecoTelaApp() {

		String dataTelaConfirmacao = obterTextoAtributo(By.xpath("(//android.widget.ImageView)[1]"));
		String endereco01 = dataTelaConfirmacao.replaceAll("\n", " ");
		String endereco02 = endereco01.substring(41, 61);
		return endereco02;

	}

	public String verificarDadosTelaExame() {
		return obterTextoAtributo(By.xpath("(//android.view.View)[10]"));

	}

	public String verificarHoraTelaExameApp() {

		String textoTela = obterTextoAtributo(By.xpath("(//android.view.View)[10]"));
		String horaTelaApp = textoTela.replaceAll("\n", " ").substring(18, 24).trim();

		return horaTelaApp;

	}

	public void botaoAceitarAgendamentoExame() {
		tapNormal(527, 967);
		// clicar(By.xpath("(//android.widget.ImageView)[1]"));

	}

	public String TelaAgendamentoRealizado() {
		return obterTextoAtributo(MobileBy.AccessibilityId("Exame agendado"));
	...
	public String horaLocal() {
		...
		// HH:mm");
		//
		// String formata = dtf.format(LocalDateTime.now());
		//
		// String hora = formata.toString();
		// //String hora = formata.substring(11,17);
		// return hora.substring(11,16).trim();
	}

	public void clicarBotaoHome() {
		clicar(MobileBy.AccessibilityId("IR PARA A HOME"));

	}

	public void botaoConfirmarExame() {
		clicar(MobileBy.AccessibilityId("CONFIRMAR EXAME"));
	...
	public void botaoJaRealizeiExame() {
		clicar(MobileBy.AccessibilityId("JÁ REALIZEI O EXAME"));

	}

	public void botaoAnexarExame() {
		clicar(By.xpath("(//android.view.View/android.view.View/android.widget.ImageView)[3]"));
       
	}

	public String verificarTextoExameEnviado() {
		return obterTextoAtributo(By.xpath("(//android.view.View)[9]"));

	}

	public void botaoIrParaHome() {
		clicar(MobileBy.AccessibilityId("IR PARA A HOME"));

	}

	public String telaHomeExameAnalisando() {
		String textoExame = obterTextoAtributo(By.xpath("(//android.view.View)[10]"));
		String textoExame01 = textoExame.replaceAll("\n", " ");
		String textoExame02 = textoExame01.substring(174,237);
		return textoExame02.trim();
	}

	public String telaHomeExameAprovado() {
		String textoExame = obterTextoAtributo(By.xpath("(//android.widget.ImageView)[2]"));
		String textoExame01 = textoExame.replaceAll("\n", " ");
		String textoExame02 = textoExame01.substring(156,196);
		return textoExame02.trim();
	}
