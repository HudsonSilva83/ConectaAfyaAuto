...
public class AdicionarDadosBancariosStep extends BaseTest {
	...
	private String feature = "Adicionar Dados Bancarios";
	...
	static ExcluirGeralDAO excluirGeral = new ExcluirGeralDAO();
	...
	@Before
	public void setCenario(Scenario cen) throws SQLException {
		// feature = cen.getId().split(";")[0];
		cenario = cen.getName();
		excluirGeral.excluirGeral();
	...
	public void aciono_o_comando_enviar_depois() throws InterruptedException {
		Thread.sleep(500);
	...
	public void aciono_o_comando_adicionar_uma_conta_depois() throws InterruptedException {
         
		Thread.sleep(2000);
		dadosBancarios.scrollar(0.7, 0.1);
